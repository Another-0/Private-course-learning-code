...
int main() {
	...
	rgb = readbmp("C:/Users/fly/Desktop/数字图像处理/shiyan3/3.bmp", "rb");
	...
	//savebmp(outrgb, "C:/Users/fly/Desktop/数字图像处理/shiyan3/31.bmp");
	savebmp(outrgb, "C:/Users/fly/Desktop/数字图像处理/shiyan3/32.bmp");
	free(outrgb);
	free(rgb);
	return 0;
}
